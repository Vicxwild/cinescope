...
class TestGetId:
    ...
    def test_negative_with_wrong_id(self, api_manager):
    ...
    def test_negative_with_string_id(self, api_manager):
        movie_id = faker.word()

        get_resp = api_manager.movies_api.get_movie(movie_id, expected_status=500)
        get_data = get_resp.json()
